defmodule Rocketpay.Accounts.Transaction do
  ...
  alias Rocketpay.Accounts.Transactions.Response, as: TransactionResonse
  ...
  def call(%{"from" => from_id, "to" => to_id, "value" => value}) do
    ...
    Multi.new()
    |> Multi.merge(fn _change -> Operation.call(withdraw_params, :withdraw) end)
    |> Multi.merge(fn _change -> Operation.call(deposit_params, :deposit) end)
    |> run_transaction()
  end
